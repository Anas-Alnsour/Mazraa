    ...
    <div class="max-w-4xl mx-auto bg-white p-8 mt-10 rounded-xl shadow-lg">
        ...
        <form action="{{ route('admin.farms.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div>
                ...
                <input type="text" name="name" class="w-full border rounded-lg p-3" placeholder="Farm name..."
                    required>
            </div>

            <div>
                <label class="block text-gray-700 font-semibold">Location</label>
                <input type="text" name="location" class="w-full border rounded-lg p-3" placeholder="City / Area"
                    required>
            </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div>
                    ...
                    <input type="number" name="rating" class="w-full border rounded-lg p-3" step="0.1" min="1"
                        max="5" required>
                </div>
            </div>
