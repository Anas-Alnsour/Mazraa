...
<div class="bg-gray-50 rounded-2xl shadow-md hover:shadow-xl 
            ...
            transform hover:scale-105">
                ...
                <div class="relative">
                    ...
                    <!-- Overlay عند المرور -->
                    <div class="absolute inset-0 rounded-xl bg-black bg-opacity-50 opacity-0 hover:opacity-100 transition-opacity duration-300 flex items-end">
