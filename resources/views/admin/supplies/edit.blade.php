...
@section('content')
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div class="flex items-center justify-between mb-8">
            <div>
                <h1 class="text-3xl font-extrabold text-gray-900 tracking-tight">Edit Supply</h1>
                <p class="mt-1 text-gray-500 text-sm">Update inventory details and pricing.</p>
            </div>
        ...
        <form action="{{ route('admin.supplies.update', $supply->id) }}" method="POST" enctype="multipart/form-data"
              ...
              x-data="{
                  imagePreview: '{{ $supply->image ? Storage::url($supply->image) : '' }}'
              }">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div class="md:col-span-1">
                    ...
                    <div class="relative group">
                        <div class="w-full h-64 rounded-2xl border-2 border-dashed border-gray-300 overflow-hidden flex items-center justify-center bg-gray-50 hover:bg-gray-100 transition cursor-pointer relative">
                ...
                <div class="md:col-span-2 space-y-6">
                    ...
                    <div class="grid grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="number" name="price" value="{{ old('price', $supply->price) }}" step="0.01"
                                   class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-100 outline-none transition-all" required>
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-gray-700 mb-2">Quantity</label>
                            {{-- تم تغيير الاسم من stock إلى quantity --}}
                            <input type="number" name="quantity" value="{{ old('quantity', $supply->stock) }}"
                                   class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-100 outline-none transition-all" required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <textarea name="description" rows="4"
                                  class="w-full px-4 py-3 rounded-xl border border-gray-200 bg-gray-50 focus:bg-white focus:border-blue-500 focus:ring-4 focus:ring-blue-100 outline-none transition-all resize-none">{{ old('description', $supply->description) }}</textarea>
                    </div>
            ...
            <div class="pt-6 border-t border-gray-100 flex justify-end">
                <button type="submit" class="px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl shadow-lg hover:shadow-blue-200 transition-all transform hover:-translate-y-0.5">
                    Save Changes
                </button>
            </div>
