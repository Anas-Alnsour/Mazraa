    ...
    <div class="max-w-7xl mx-auto px-6 lg:px-8">
        <div class="flex items-center justify-start h-20 space-x-10">
            ...
            <div class="flex-shrink-0 flex items-center">
                <a href="{{ url('/') }}" class="text-4xl font-black tracking-tighter text-green-800 hover:text-green-600 transition duration-300">
            ...
            <div class="flex items-center space-x-5 text-sm font-medium">
                @auth
                    <div class="flex items-center gap-2 whitespace-nowrap bg-green-200 rounded-full py-2 px-4 text-green-800">
...
<div x-data="{ show: true }" x-show="show" x-init="setTimeout(() => show = false, 5000)"
    ...
    @if(session('success'))
        <div class="max-w-xs shadow-2xl rounded-lg overflow-hidden transition-all duration-500 transform translate-x-0 opacity-100">
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-12">
            ...
            <div>
                ...
                <ul class="space-y-3 text-sm">
                    <li><a href="/" class="text-gray-400 hover:text-green-300 transition duration-200 flex items-center gap-2"> Home</a></li>
                    <li><a href="{{ route('explore') }}" class="text-gray-400 hover:text-green-300 transition duration-200 flex items-center gap-2"> Explore Farms</a></li>
                    <li><a href="{{ route('contact') }}" class="text-gray-400 hover:text-green-300 transition duration-200 flex items-center gap-2"> Contact</a></li>
                    <li><a href="{{ route('about') }}" class="text-gray-400 hover:text-green-300 transition duration-200 flex items-center gap-2"> About</a></li>
                </ul>
            </div>
