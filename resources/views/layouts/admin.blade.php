...
<body class="bg-slate-900 font-sans antialiased text-slate-200 flex h-screen overflow-hidden" x-data="{ sidebarOpen: false }">
    ...
    <aside :class="{'translate-x-0': sidebarOpen, '-translate-x-full': !sidebarOpen}" class="fixed inset-y-0 left-0 z-30 w-72 bg-slate-900 text-white transition-transform duration-300 lg:translate-x-0 lg:static lg:inset-0 flex flex-col shadow-2xl">
        ...
        <nav class="flex-1 px-4 py-8 space-y-3 overflow-y-auto">
            ...
            <a href="{{ route('admin.farms.index') }}" class="flex items-center gap-3 px-4 py-4 rounded-2xl font-bold text-sm transition-all transform active:scale-95 {{ request()->routeIs('admin.farms.*') ? 'bg-emerald-600 text-white shadow-lg shadow-emerald-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
                <svg class="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"/></svg>
                Manage Farms
            </a>

            <a href="{{ route('admin.supplies.index') }}" class="flex items-center gap-3 px-4 py-4 rounded-2xl font-bold text-sm transition-all transform active:scale-95 {{ request()->routeIs('admin.supplies.*') ? 'bg-lime-600 text-white shadow-lg shadow-lime-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
            ...
            <a href="{{ route('admin.users.index') }}" class="flex items-center gap-3 px-4 py-4 rounded-2xl font-bold text-sm transition-all transform active:scale-95 {{ request()->routeIs('admin.users.*') ? 'bg-indigo-600 text-white shadow-lg shadow-indigo-900/20' : 'text-slate-400 hover:bg-slate-800 hover:text-white' }}">
