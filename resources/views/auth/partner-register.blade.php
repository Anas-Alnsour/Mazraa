...
<body class="bg-white antialiased text-gray-900 relative overflow-x-hidden min-h-screen" x-data="{ mounted: false }"
    ...
    <div class="flex flex-col lg:flex-row w-full min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-[45%] relative overflow-hidden bg-[#020617] sticky top-0 h-screen">
            ...
            <div
                class="absolute top-1/4 left-1/4 w-96 h-96 bg-[#1d5c42]/30 rounded-full blur-[120px] animate-float pointer-events-none z-0">
            </div>
            <div class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-[#c2a265]/20 rounded-full blur-[120px] animate-float pointer-events-none z-0"
            ...
            <div class="relative z-20 flex flex-col justify-end p-12 lg:p-16 w-full h-full pb-24">
                <div class="glass-panel p-10 rounded-[2.5rem] max-w-xl transition-all duration-700 transform"
                    ...
                    <p class="text-lg text-gray-300 font-medium leading-relaxed drop-shadow-md">
                        Join the elite network of farm owners. List your property, manage bookings, and increase your
                        revenue securely.
                    </p>
                </div>
            </div>
        ...
        <div class="w-full lg:w-[55%] flex flex-col relative bg-white min-h-screen">
            ...
            <div class="absolute top-6 left-6 sm:top-8 sm:left-12 z-20">
                <a href="{{ url('/') }}"
                    class="group flex items-center gap-2 text-xs font-black uppercase tracking-widest text-gray-400 hover:text-[#1d5c42] transition-colors duration-300">
                    <div
            ...
            <div class="flex-1 flex flex-col px-6 sm:px-12 md:px-16 lg:px-20 xl:px-28 py-24 sm:py-28">
                ...
                <div class="mb-10 transition-all duration-700 delay-100 transform"
                    ...
                    <p class="text-base text-gray-500 font-medium">Fill in your details to set up your business portal.
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('partner.register.store') }}" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 transition-all duration-700 delay-200 transform"
                        ...
                        <div class="group">
                            <label for="name"
                                class="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-2 transition-colors group-focus-within:text-[#1d5c42]">Full
                                Name</label>
                        ...
                        <div class="group">
                            <label for="phone"
                                class="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-2 transition-colors group-focus-within:text-[#1d5c42]">Phone
                                Number</label>
                    ...
                    <div class="group transition-all duration-700 delay-300 transform"
                        :class="mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'">
                        <label for="email"
                            class="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-2 transition-colors group-focus-within:text-[#1d5c42]">Email
                            Address</label>
                    ...
                    {{-- Passwords --}}
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 transition-all duration-700 delay-400 transform"
                        :class="mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'">
                        ...
                        <div class="bg-gray-50 rounded-3xl p-6 sm:p-8 border border-gray-200 shadow-inner">
                            <div class="flex items-center gap-3 mb-6">
                                <div class="bg-white p-2 rounded-xl shadow-sm border border-gray-100">
                                    <svg class="w-6 h-6 text-[#1d5c42]" fill="none" stroke="currentColor"
                                        viewBox="0 0 24 24">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-0.5">Where should we send your earnings? <span
                                            class="italic">(Optional for now)</span></p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-5">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                                    <div class="group">
                                        <label for="bank_name"
                                            class="block text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2 transition-colors group-focus-within:text-[#1d5c42]">Bank
                                            Name</label>
                                    ...
                                    <div class="group">
                                        <label for="account_holder_name"
                                            class="block text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2 transition-colors group-focus-within:text-[#1d5c42]">Account
                                            Holder</label>
                                ...
                                <div class="group">
                                    <label for="iban"
                                        class="block text-[10px] font-black uppercase tracking-widest text-gray-500 mb-2 transition-colors group-focus-within:text-[#1d5c42]">IBAN
                                        Number</label>
                    ...
                    {{-- Terms Checkbox --}}
                    <div class="flex items-center pt-4 transition-all duration-700 delay-[600ms] transform"
                        :class="mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'">
                        ...
                        <div class="ml-3 text-sm">
                            <label for="terms" class="font-medium text-gray-600 cursor-pointer">
                                I agree to the <a href="javascript:void(0);"
                                    class="font-bold text-[#1d5c42] hover:text-[#154531] transition-colors border-b border-transparent hover:border-[#154531]">Terms
                                    and Conditions</a>
                                and <a href="javascript:void(0);"
                                    class="font-bold text-[#1d5c42] hover:text-[#154531] transition-colors border-b border-transparent hover:border-[#154531]">Privacy
                                    Policy</a>.
                            </label>
                        </div>
                    </div>
                    ...
                    {{-- Submit Button --}}
                    <div class="pt-4 transition-all duration-700 delay-[700ms] transform"
                        :class="mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'">
                        <button type="submit"
                ...
                {{-- Footer Login Link --}}
                <div class="mt-8 text-center transition-all duration-700 delay-[800ms] transform"
                    :class="mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'">
                    <p class="text-sm font-medium text-gray-500">
                        Already a partner?
                        <a href="{{ route('portal.login') }}"
                            class="font-black text-[#1d5c42] hover:text-[#154531] transition-colors ml-1 border-b-2 border-transparent hover:border-[#1d5c42] pb-0.5">
                            Sign in here
                        </a>
                    </p>
                </div>
