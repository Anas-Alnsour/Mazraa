...
<body class="bg-white antialiased text-gray-900 relative overflow-hidden min-h-screen" x-data="{ mounted: false }"
    ...
    <div class="flex flex-col lg:flex-row w-full min-h-screen">
        ...
        <div class="hidden lg:flex lg:w-[55%] relative overflow-hidden bg-[#020617] h-screen sticky top-0">
            ...
            <img src="{{ asset('images/company-supply.png') }}" alt="Supply Background"
            ...
            <div
                class="absolute top-1/4 left-1/4 w-96 h-96 bg-indigo-500/20 rounded-full blur-[120px] animate-float pointer-events-none z-0">
            </div>
            <div class="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-600/20 rounded-full blur-[120px] animate-float pointer-events-none z-0"
                ...
                <div class="glass-panel p-10 rounded-[2.5rem] max-w-xl transition-all duration-700 transform"
                    ...
                    <div class="mb-8 flex items-center gap-4">
                        ...
                        <h2 class="text-3xl font-black text-white tracking-tighter">Mazraa<span
                                class="text-indigo-400">.com</span></h2>
                    </div>
                    ...
                    <p class="text-lg text-gray-200 font-medium leading-relaxed drop-shadow-md">
                        Manage your inventory, fulfill farm orders, and grow your business seamlessly within the Mazraa
                        ecosystem.
                    </p>
                </div>
            </div>
        ...
        <div class="w-full lg:w-[45%] flex flex-col relative bg-white overflow-y-auto min-h-screen">
            ...
            <div class="absolute top-8 left-8 sm:left-12 z-20">
                <a href="{{ url('/') }}"
                    class="group flex items-center gap-2 text-xs font-black uppercase tracking-widest text-gray-400 hover:text-indigo-600 transition-colors duration-300">
                    <div
            ...
            <div class="flex-1 flex flex-col justify-center px-8 sm:px-16 lg:px-20 xl:px-28 py-24 min-h-full">
                ...
                <div class="lg:hidden mb-12 flex items-center gap-3 transition-all duration-700 transform"
                    ...
                    <span class="text-3xl font-black tracking-tighter text-gray-900">Mazraa<span
                            class="text-indigo-500">.com</span></span>
                </div>
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <input type="hidden" name="expected_role" value="supply_company">

                    {{-- Email Input --}}
                    <div class="group transition-all duration-700 delay-200 transform"
                        :class="mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'">
                        <label for="email"
                            class="block text-[11px] font-black uppercase tracking-widest text-gray-500 mb-2 transition-colors group-focus-within:text-indigo-600">Email
                            Address</label>
                        <div class="relative">
                    ...
                    <div class="group transition-all duration-700 delay-300 transform"
                        :class="mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'">
                        <x-password-toggle id="password" name="password" type="login" color="indigo"
                            hide-internal-eye>
                            Password
                        </x-password-toggle>
