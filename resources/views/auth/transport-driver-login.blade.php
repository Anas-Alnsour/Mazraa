...
<body class="font-sans text-gray-900 antialiased bg-slate-50 relative overflow-hidden">
    ...
    @php
        ...
        $textAccent = 'amber-400';
        $blobOne = 'bg-amber-200';
        $blobTwo = 'bg-orange-100';
        $btnGradientFrom = 'from-amber-500';
        $btnGradientTo = 'to-orange-600';
    @endphp
    ...
    <div class="min-h-screen flex relative z-10">
        ...
        <div class="hidden lg:flex lg:w-[55%] relative overflow-hidden bg-gray-900 group">
            ...
            <img src="https://images.unsplash.com/photo-1519003722824-194d4455a60c?ixlib=rb-4.0.3&auto=format&fit=crop&w=1920&q=80"
                 alt="Background"
        ...
        <div class="w-full lg:w-[45%] flex flex-col relative px-8 py-10 sm:px-16 lg:px-20 xl:px-28 bg-white/60 backdrop-blur-xl">
            ...
            <div class="flex-1 flex flex-col justify-center mt-12 lg:mt-0">
                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-6">
                    ...
                    <div class="pt-6">
                        <button type="submit"
                            class="relative w-full flex justify-center py-4 px-4 border border-transparent rounded-2xl shadow-[0_8px_20px_-6px_rgba(245,158,11,0.5)] text-base font-extrabold text-white bg-gradient-to-r {{ $btnGradientFrom }} {{ $btnGradientTo }} hover:shadow-lg hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-offset-2 transition-all duration-300 ease-out overflow-hidden group">
