...
<div class="relative min-h-[calc(100vh-8rem)]"
    ...
    <div class="relative z-10 flex justify-center items-center min-h-[calc(100vh-8rem)] px-4">
        <div class="w-full max-w-xl bg-white/20 backdrop-blur-xl rounded-3xl shadow-2xl
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6">
                ...
                <div>
                    <label for="password_confirmation" class="text-white/90 font-semibold mb-2 block">Confirm Password</label>
                ...
                <div class="flex flex-col md:flex-row items-center justify-between mt-6 gap-3">
                    <a href="{{ route('login') }}" class="text-sm text-white/90 underline hover:text-white">Already registered?</a>
                    <button type="submit"
