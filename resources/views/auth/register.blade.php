...
<head>
    ...
    <title>Register - {{ config('app.name', 'Mazraa') }}</title>
    ...
    <style>
        ...
        /* Custom scrollbar for the right side if content is long */
...
<body class="font-sans text-gray-900 antialiased bg-slate-50 relative overflow-hidden h-screen">
    ...
    <div class="h-screen flex relative z-10">
        ...
        <div class="hidden lg:flex lg:w-[45%] xl:w-[50%] relative overflow-hidden bg-gray-900 group">
            ...
            <div class="absolute inset-0 bg-gradient-to-tr from-green-950/95 via-emerald-900/80 to-transparent"></div>
            ...
            <div class="absolute top-12 left-12 glass-panel rounded-full px-6 py-2 flex items-center space-x-3 shadow-2xl animate-bounce" style="animation-duration: 3s;">
                ...
                <span class="text-white text-sm font-medium tracking-wide">Join 10,000+ Members</span>
            </div>
            ...
            <div class="relative z-10 flex flex-col justify-end p-16 w-full h-full">
                <div class="glass-panel p-10 rounded-[2rem] shadow-[0_8px_32px_0_rgba(0,0,0,0.3)] max-w-xl mb-6 transform transition-all hover:-translate-y-2 duration-500 border-l-4 border-l-green-400">
                    ...
                    <h1 class="text-5xl font-extrabold text-white mb-6 leading-tight">
                        Grow with <br> <span class="text-transparent bg-clip-text bg-gradient-to-r from-green-300 to-emerald-200">Our Community.</span>
                    </h1>
                    ...
                    <ul class="space-y-3">
                        <li class="flex items-center text-green-100">
                            ...
                            Instant bookings for top-rated farms
                        </li>
                        <li class="flex items-center text-green-100">
                            <svg class="w-5 h-5 text-green-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            Integrated transport & supply services
                        </li>
                        <li class="flex items-center text-green-100">
                            <svg class="w-5 h-5 text-green-400 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            Secure and unified dashboard
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="flex-1 flex flex-col justify-center max-w-lg mx-auto w-full pt-16 lg:pt-0">
                ...
                <div class="mb-8 text-center lg:text-left">
                    ...
                    <p class="text-base text-gray-500 font-medium">
                        ...
                        <a href="{{ route('login') }}" class="font-extrabold text-green-600 hover:text-emerald-700 transition-colors ml-1 border-b-2 border-transparent hover:border-emerald-700 pb-0.5">
                            Sign in instead
                        </a>
                    </p>
                </div>
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-5">
                    ...
                    <div class="group">
                        <label for="name" class="block text-sm font-bold text-gray-700 mb-1.5 transition-colors group-focus-within:text-green-600">Full Name</label>
                        <div class="relative">
                            ...
                            <input id="name" name="name" type="text" required autofocus autocomplete="name"
                                class="pl-12 block w-full bg-white border border-gray-200 text-gray-900 rounded-2xl shadow-sm focus:bg-white focus:ring-4 focus:ring-green-500/20 focus:border-green-500 sm:text-base py-3 transition-all duration-300 {{ $errors->has('name') ? 'border-red-500 ring-4 ring-red-500/20' : '' }}"
                    ...
                    <div class="group">
                        <label for="email" class="block text-sm font-bold text-gray-700 mb-1.5 transition-colors group-focus-within:text-green-600">Email Address</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400 group-focus-within:text-green-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <input id="email" name="email" type="email" autocomplete="username" required
                                class="pl-12 block w-full bg-white border border-gray-200 text-gray-900 rounded-2xl shadow-sm focus:bg-white focus:ring-4 focus:ring-green-500/20 focus:border-green-500 sm:text-base py-3 transition-all duration-300 {{ $errors->has('email') ? 'border-red-500 ring-4 ring-red-500/20' : '' }}"
                    ...
                    <div class="group">
                        <label for="phone" class="block text-sm font-bold text-gray-700 mb-1.5 transition-colors group-focus-within:text-green-600">Phone Number</label>
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <svg class="h-5 w-5 text-gray-400 group-focus-within:text-green-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <input id="phone" name="phone" type="tel" required autocomplete="tel"
                                class="pl-12 block w-full bg-white border border-gray-200 text-gray-900 rounded-2xl shadow-sm focus:bg-white focus:ring-4 focus:ring-green-500/20 focus:border-green-500 sm:text-base py-3 transition-all duration-300 {{ $errors->has('phone') ? 'border-red-500 ring-4 ring-red-500/20' : '' }}"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        <div class="group">
                            <label for="password" class="block text-sm font-bold text-gray-700 mb-1.5 transition-colors group-focus-within:text-green-600">Password</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 group-focus-within:text-green-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <input id="password" name="password" type="password" autocomplete="new-password" required
                                    class="pl-12 block w-full bg-white border border-gray-200 text-gray-900 rounded-2xl shadow-sm focus:bg-white focus:ring-4 focus:ring-green-500/20 focus:border-green-500 sm:text-base py-3 transition-all duration-300 {{ $errors->has('password') ? 'border-red-500 ring-4 ring-red-500/20' : '' }}"
                                    placeholder="••••••••">
                            </div>
                        ...
                        <div class="group">
                            <label for="password_confirmation" class="block text-sm font-bold text-gray-700 mb-1.5 transition-colors group-focus-within:text-green-600">Confirm Password</label>
                            <div class="relative">
                                <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                    <svg class="h-5 w-5 text-gray-400 group-focus-within:text-green-500 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <input id="password_confirmation" name="password_confirmation" type="password" required autocomplete="new-password"
                                    class="pl-12 block w-full bg-white border border-gray-200 text-gray-900 rounded-2xl shadow-sm focus:bg-white focus:ring-4 focus:ring-green-500/20 focus:border-green-500 sm:text-base py-3 transition-all duration-300"
                                    placeholder="••••••••">
                            </div>
                    ...
                    <div class="flex items-start pt-2">
                        <div class="flex items-center h-5">
                            <input id="terms" name="terms" type="checkbox" required
                                class="w-4 h-4 border border-gray-300 rounded bg-gray-50 focus:ring-3 focus:ring-green-300 accent-green-600 cursor-pointer">
                        </div>
                        <div class="ml-3 text-sm">
                            <label for="terms" class="font-medium text-gray-600 cursor-pointer">
                                I agree to the
                                <a href="#" class="text-green-600 hover:text-green-700 hover:underline">Terms and Conditions</a>
                                and
                                <a href="#" class="text-green-600 hover:text-green-700 hover:underline">Privacy Policy</a>.
                            </label>
                        </div>
                    </div>
