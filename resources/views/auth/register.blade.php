        ...
        <div class="hidden lg:flex lg:w-[45%] xl:w-[50%] relative overflow-hidden bg-[#020617]">
            ...
            <div class="relative z-10 flex flex-col justify-end p-16 w-full h-full pb-24">
                <div class="glass-panel p-10 rounded-[2.5rem] max-w-xl transition-all duration-700 transform"
                    ...
                    <ul class="space-y-4">
                        <li class="flex items-center text-gray-100 font-medium text-sm">
                            <svg class="w-5 h-5 {{ $iconColor }} mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"></path></svg>
                            {{ $isPartner ? 'Automated financial tracking & reports' : 'Instant bookings for top-rated luxury farms' }}
                        </li>
                        <li class="flex items-center text-gray-100 font-medium text-sm">
                            <svg class="w-5 h-5 {{ $iconColor }} mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"></path></svg>
                        ...
                        <li class="flex items-center text-gray-100 font-medium text-sm">
                            <svg class="w-5 h-5 {{ $iconColor }} mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M5 13l4 4L19 7"></path></svg>
                            {{ $isPartner ? 'Secure role-based dual-portal access' : 'Secure and unified user dashboard' }}
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="w-full lg:w-[55%] xl:w-[50%] flex flex-col relative bg-white h-full overflow-y-auto custom-scrollbar">
            ...
            <div class="flex-1 flex flex-col justify-center px-8 sm:px-16 lg:px-20 xl:px-28 py-20 min-h-full">
                ...
                <div class="lg:hidden mb-12 flex items-center gap-3 transition-all duration-700 transform" :class="mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'">
                    <div class="bg-gradient-to-r {{ $btnGradient }} p-2.5 rounded-xl text-white shadow-lg">
                        @if($isPartner)
                    ...
                    <span class="text-3xl font-black tracking-tighter text-gray-900">Mazraa<span class="{{ $textAccent }}">.com</span></span>
                </div>
                ...
                <form method="POST" action="{{ $postUrl }}" class="space-y-5">
                    ...
                    <div class="group transition-all duration-700 delay-200 transform" :class="mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'">
                        ...
                        <x-input-error :messages="$errors->get('name')" class="mt-2 text-sm text-red-600 font-bold" />
                    </div>
                    ...
                    {{-- Phone Input --}}
                    <div class="group transition-all duration-700 delay-[400ms] transform" :class="mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'">
                        ...
                        <x-input-error :messages="$errors->get('phone')" class="mt-2 text-sm text-red-600 font-bold" />
                    </div>

                    {{-- Passwords Grid --}}
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 transition-all duration-700 delay-[500ms] transform" :class="mounted ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'">
                        <div class="group">
