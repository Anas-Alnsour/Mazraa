...
@section('title', 'CliQ Payment - Supplies')
        ...
        <div class="bg-white rounded-[2rem] shadow-2xl border border-purple-100 overflow-hidden relative">
            ...
            <div class="bg-gradient-to-r from-purple-700 to-purple-900 p-8 text-center relative">
                ...
                <div class="relative z-10 flex flex-col items-center">
                    ...
                    <p class="text-purple-300 text-xs mt-2 uppercase tracking-widest">Invoice: {{ $order_id }}</p>
                </div>
            </div>
            ...
            <div class="p-8">
                <div class="flex justify-between items-center mb-6 pb-6 border-b border-gray-100">
                    ...
                    <span class="text-3xl font-black text-gray-900">{{ number_format($totalPrice, 2) }} <span class="text-sm">JOD</span></span>
                </div>
                ...
                <div class="bg-purple-50 border border-purple-100 p-4 rounded-xl mb-6">
                    ...
                    <p class="text-[11px] text-purple-600 leading-relaxed">
                        Please ensure you transfer the exact amount to our official CliQ Alias:
                        <strong class="bg-white px-2 py-0.5 rounded text-purple-900 border border-purple-200 cursor-pointer hover:bg-purple-100 transition-colors" onclick="navigator.clipboard.writeText('MAZRAA'); alert('Alias Copied!');" title="Click to copy">MAZRAA</strong>
                    </p>
                </div>

                {{-- 💡 راوت التأكيد الخاص بالمشتريات --}}
                <form action="{{ route('payment.supply.confirm_cliq', $order_id) }}" method="POST">
                    @csrf
                ...
                <div class="mt-6 text-center">
                    {{-- 💡 راوت الرجوع لاختيار الدفع الخاص بالمشتريات --}}
                    <a href="{{ route('payment.select_supply', $order_id) }}" class="text-xs font-bold text-gray-400 hover:text-gray-600 transition-colors">
