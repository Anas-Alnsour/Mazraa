...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            <h1 class="text-3xl font-black text-slate-900 tracking-tight">Add New Driver</h1>
            <p class="text-sm font-bold text-slate-500 tracking-widest uppercase mt-1">Register a fleet member</p>
        </div>
    ...
    <div class="bg-white rounded-[2.5rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-100 p-8 sm:p-12">
        <form action="{{ route('transport.drivers.store') }}" method="POST" class="space-y-8">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    <label for="password" class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 px-1">Password</label>
                ...
                <div>
                    <label for="password_confirmation" class="block text-[10px] font-black text-slate-500 uppercase tracking-widest mb-2 px-1">Confirm Password</label>
                ...
                <div class="md:col-span-2 pt-4 border-t border-slate-100">
                    ...
                    <div class="relative">
                        <select name="governorate" id="governorate" required class="block w-full rounded-2xl border-slate-200 bg-slate-50 shadow-inner focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/10 sm:text-sm font-bold text-slate-900 px-5 py-4 appearance-none cursor-pointer transition-all">
                            ...
                            {{-- 💡 التعديل هنا: قراءة المحافظات من ملف الإعدادات مباشرة --}}
