...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-sm font-bold text-gray-400 tracking-widest uppercase mt-1">Register a fleet member</p>
        </div>
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 sm:p-12">
        <form action="{{ route('transport.drivers.store') }}" method="POST" class="space-y-8">
            ...
            <div class="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-end gap-4">
