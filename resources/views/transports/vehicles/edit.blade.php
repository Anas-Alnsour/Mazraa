...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    ...
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-sm font-bold text-gray-400 tracking-widest uppercase mt-1">Update asset <span class="bg-gray-100 text-gray-800 px-2 py-0.5 rounded-md font-mono">{{ $vehicle->license_plate }}</span></p>
        </div>
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 sm:p-12">
        <form action="{{ route('transport.vehicles.update', $vehicle->id) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="md:col-span-2 pt-4 border-t border-gray-100 mt-2">
                    <label for="driver_id" class="block text-xs font-black text-gray-500 uppercase tracking-widest mb-2 px-1">Assign Driver (Optional)</label>
            ...
            <div class="pt-8 border-t border-gray-100">
                <label class="block text-xs font-black text-gray-500 uppercase tracking-widest mb-4 px-1">Current Status</label>
            ...
            <div class="pt-8 mt-8 border-t border-gray-100 flex flex-col md:flex-row justify-end gap-4">
                <a href="{{ route('transport.vehicles.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-800 font-black py-4 px-10 rounded-2xl transition-all transform active:scale-95 tracking-widest uppercase text-sm w-full md:w-auto text-center border border-gray-200">
                    Cancel
                </a>
