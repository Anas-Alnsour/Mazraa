...
@section('title', 'Deploy New Vehicle and Register Driver - Mazraa Transport Management')
...
@section('content')
    ...
    <div class="max-w-[96%] xl:max-w-5xl mx-auto space-y-10 pb-24 animate-god-in fade-in-up">
        ...
        <div
            ...
            <div class="absolute -left-20 -bottom-20 w-64 h-64 bg-blue-500/10 blur-[80px] rounded-full pointer-events-none">
            </div>
            ...
            <div class="relative z-10">
                ...
                <h1 class="text-4xl md:text-5xl font-black text-white tracking-tighter mb-2 leading-none">Deploy <span
                        class="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-400">Vehicle with its
                        driver</span></h1>
                <p class="text-slate-400 font-bold uppercase tracking-widest text-[10px] mt-3">Add a new vehicle to your
                    fleet and assign a driver</p>
            </div>
        ...
        <div
            ...
            <form action="{{ route('transport.vehicles.store') }}" method="POST" class="space-y-10 relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="md:col-span-2 space-y-2">
                        ...
                        <div class="relative group">
                            <div
                                class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none text-slate-600 group-focus-within:text-cyan-400 transition-colors">
                                <svg class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                            ...
                            <input type="text" name="name" id="name" value="{{ old('name') }}" required
                                placeholder="e.g. Ahmad Ali" class="w-full transport-input pl-12 py-4 font-bold text-sm">
                        </div>
                    </div>
                    ...
                    <div class="md:col-span-2 pt-6 border-t border-slate-800 space-y-2">
                        ...
                        <select name="shift" id="shift" required
                            ...
                            <option value="morning" {{ old('shift') == 'morning' ? 'selected' : '' }}>☀️ Morning Shift
                                (08:00 AM - 05:00 PM)</option>
                            <option value="evening" {{ old('shift') == 'evening' ? 'selected' : '' }}>🌙 Evening Shift
                                (07:00 PM - 06:00 AM)</option>
                        </select>
                    </div>
                    ...
                    <div class="md:col-span-2 space-y-2">
                        ...
                        <select name="type" id="type" required
                            ...
                            <option value="Van (12 Seats)" {{ old('type') == 'Van (12 Seats)' ? 'selected' : '' }}>Van (12
                                Seats)</option>
                            ...
                            <option value="Large Bus (50 Seats)"
                                {{ old('type') == 'Large Bus (50 Seats)' ? 'selected' : '' }}>Large Bus (50 Seats)</option>
                            <option value="SUV / 4x4" {{ old('type') == 'SUV / 4x4' ? 'selected' : '' }}>SUV / 4x4
                            </option>
                            <option value="Sedan (VIP)" {{ old('type') == 'Sedan (VIP)' ? 'selected' : '' }}>Sedan (VIP)
                            </option>
                        </select>
                    </div>
                ...
                {{-- Security Protocol --}}
                <div
                    class="grid grid-cols-1 md:grid-cols-2 gap-8 md:col-span-2 p-6 md:p-8 bg-slate-950/50 rounded-[2rem] border border-slate-800 shadow-inner">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            <input type="password" name="password" id="password" required
                                class="w-full transport-input bg-slate-800/50 border border-slate-700 text-white px-5 py-4 pr-12 font-bold tracking-widest focus:border-rose-500 focus:outline-none transition-all">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <button type="button" onclick="togglePassword('password_confirmation', 'eye_icon_verify')"
                                class="absolute inset-y-0 right-0 pr-4 flex items-center hover:text-rose-500 transition-colors">
                ...
                <div class="pt-8 mt-8 flex flex-col md:flex-row justify-end gap-5 border-t border-slate-800">
                    <a href="{{ route('transport.vehicles.index') }}"
                        class="w-full md:w-auto py-5 px-12 bg-slate-950 text-slate-400 hover:text-white border border-slate-800 hover:border-slate-600 text-[11px] font-black uppercase tracking-[0.2em] rounded-2xl shadow-inner transition-all active:scale-95 flex items-center justify-center text-center">
                        Cancel Operation
                    </a>
                    <button type="submit"
