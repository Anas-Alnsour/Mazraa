...
<style>
    ...
    .transport-input::placeholder { color: #64748b !important; font-weight: 500; font-size: 11px; text-transform: uppercase; letter-spacing: 0.1em; }
    ...
    <div class="relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6 bg-slate-900/80 p-8 md:p-10 rounded-[3rem] border border-slate-800 backdrop-blur-2xl shadow-2xl">
        ...
        <div class="relative z-10">
            <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-slate-950/50 border border-slate-700 text-[9px] font-black uppercase tracking-widest mb-3 shadow-inner text-slate-400">
                <span class="w-1.5 h-1.5 rounded-full bg-blue-500 animate-pulse"></span> Fleet Expansion
            </div>
            ...
            <p class="text-slate-400 font-bold uppercase tracking-widest text-[10px] mt-3">Register a new asset to your transport fleet.</p>
        </div>
    ...
    @if ($errors->any())
        <div class="bg-rose-500/10 border border-rose-500/30 rounded-[2rem] p-6 shadow-inner backdrop-blur-md">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    <h3 class="text-xs font-black text-rose-400 uppercase tracking-widest mb-2">Registration Interrupted</h3>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" name="license_plate" id="license_plate" value="{{ old('license_plate') }}" required
                        ...
                        class="w-full transport-input px-5 py-4 font-black uppercase font-mono tracking-widest text-sm placeholder:normal-case">
                </div>
                ...
                <div class="space-y-2">
                    ...
                    <div class="relative">
                        <input type="number" name="capacity" id="capacity" min="1" value="{{ old('capacity') }}" required
                            placeholder="e.g. 12"
                            class="w-full transport-input pl-5 pr-14 py-4 font-bold text-sm">
