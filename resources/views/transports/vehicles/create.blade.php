...
@section('title', 'Deploy New Vehicle - Mazraa Transport Management')
    ...
    <div class="max-w-[96%] xl:max-w-5xl mx-auto space-y-10 pb-24 animate-god-in fade-in-up">
        ...
        <div class="relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6 bg-slate-900/80 p-8 md:p-10 rounded-[3rem] border border-slate-800 backdrop-blur-2xl shadow-2xl">
            ...
            <div class="relative z-10">
                ...
                <h1 class="text-4xl md:text-5xl font-black text-white tracking-tighter mb-2 leading-none">Deploy <span class="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-400">New Vehicle</span></h1>
                <p class="text-slate-400 font-bold uppercase tracking-widest text-[10px] mt-3">Add a new transport unit to your fleet</p>
            </div>
            ...
            <form action="{{ route('transport.vehicles.store') }}" method="POST" class="space-y-10 relative z-10">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="text" name="license_plate" id="license_plate" value="{{ old('license_plate') }}" required placeholder="e.g. 10-12345" class="w-full transport-input px-6 py-5 font-black uppercase font-mono tracking-widest text-sm placeholder:normal-case">
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" name="capacity" id="capacity" value="{{ old('capacity') }}" required min="1" placeholder="e.g. 4" class="w-full transport-input px-6 py-5 font-black uppercase font-mono tracking-widest text-sm">
                    </div>
                </div>
