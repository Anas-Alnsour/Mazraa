...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
    <div class="flex justify-between items-center mb-10">
        <div>
            ...
            <p class="text-sm font-bold text-gray-400 tracking-widest uppercase mt-1">Update profile for <span class="bg-gray-100 text-gray-800 px-2 py-0.5 rounded-md font-mono">{{ $driver->name }}</span></p>
        </div>
    ...
    <div class="bg-white rounded-[2.5rem] shadow-sm border border-gray-100 p-8 sm:p-12">
        <form action="{{ route('supplies.drivers.update', $driver->id) }}" method="POST" class="space-y-8">
            @csrf
            @method('PUT')
            ...
            <div class="pt-6 border-t border-gray-100">
                <div class="mb-4">
                    <h3 class="text-xs font-black text-gray-900 uppercase tracking-widest">Update Password</h3>
                    <p class="text-[10px] font-bold text-gray-400 mt-1 uppercase tracking-widest">Leave blank to keep current password</p>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div>
            ...
            <div class="pt-8 border-t border-gray-100 flex flex-col md:flex-row justify-end gap-4 mt-8">
                <a href="{{ route('supplies.drivers.index') }}" class="bg-gray-100 hover:bg-gray-200 text-gray-800 font-black py-4 px-10 rounded-2xl transition-all transform active:scale-95 tracking-widest uppercase text-sm w-full md:w-auto text-center border border-gray-200">
                    Cancel
                </a>
