...
<div class="max-w-[96%] xl:max-w-4xl mx-auto space-y-10 pb-24 animate-god-in fade-in-up">
    ...
    <div class="relative overflow-hidden flex flex-col md:flex-row md:items-center justify-between gap-6 bg-slate-900/80 p-8 md:p-10 rounded-[3rem] border border-slate-800 backdrop-blur-2xl shadow-2xl">
        ...
        <div class="relative z-10">
            ...
            <h1 class="text-4xl md:text-5xl font-black text-white tracking-tighter mb-2 leading-none">Register <span class="bg-clip-text text-transparent bg-gradient-to-r from-teal-400 to-emerald-400">Operative</span></h1>
            <p class="text-slate-400 font-bold uppercase tracking-widest text-[10px] mt-3">Add new personnel to your delivery fleet network.</p>
        </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8 mt-8 p-6 md:p-8 bg-slate-950/50 rounded-[2rem] border border-slate-800 shadow-inner">
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="password" name="password" id="password" required
                            class="w-full supply-input px-5 py-4 font-bold tracking-widest focus:border-rose-500 focus:ring-rose-500">
                    </div>
