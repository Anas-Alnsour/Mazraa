...
<div class="bg-gray-50 min-h-screen py-16">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="text-center mb-16">
            ...
            <p class="text-lg font-bold text-gray-400 max-w-2xl mx-auto uppercase tracking-widest">Premium supplies delivered directly to your farm by our B2B partners.</p>
        </div>
            ...
            @forelse($supplies as $supply)
                <div class="bg-white rounded-[2rem] shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl transition-all duration-300 group flex flex-col transform hover:-translate-y-1">
                    ...
                    <div class="p-6 flex-1 flex flex-col">
                        ...
                        <div class="flex items-center justify-between mt-auto pb-6 border-b border-gray-100 mb-6">
                        ...
                        <a href="{{ route('supplies.show', $supply->id) }}" class="block w-full text-center bg-gray-50 hover:bg-blue-600 text-gray-900 hover:text-white font-black py-4 px-4 rounded-2xl transition-all duration-200 uppercase tracking-widest text-xs border border-gray-200 hover:border-blue-600">
                            View Product
                        </a>
                    </div>
                </div>
