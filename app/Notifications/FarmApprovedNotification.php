...
class FarmApprovedNotification extends Notification implements ShouldQueue
{
    ...
    {
        return [
            // توحيد المفتاح ليتوافق مع الـ UI
            'title' => 'Property Approved',
            'message' => 'Congratulations! Your farm "' . ($this->farm->name ?? 'N/A') . '" has been verified and is now live on the platform.',
            'url' => route('owner.farms.index')
        ];
    }
}